...
const NAV = [
  ...
  { href: "/employees", icon: "👥", label: "Employees", adminOnly: false },
  { href: "/org-chart", icon: "🌳", label: "Org Chart" },
  { href: "/leave", icon: "🏖️", label: "Leave" },
  { href: "/onboarding", icon: "🆕", label: "Onboarding" },
  { href: "/offboarding", icon: "🚪", label: "Offboarding" },
  { href: "/calendar", icon: "📅", label: "Calendar" },
  { href: "/tasks", icon: "✅", label: "Tasks", adminOnly: true },
  { href: "/announcements", icon: "📢", label: "Announcements" },
  { href: "/suggestions", icon: "📬", label: "Suggestions", adminOnly: true },
